          ...
          <div className="mt-3 rounded-xl border border-slate-200 bg-slate-50/50 p-3 dark:border-slate-700 dark:bg-slate-800/50">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2.5 text-sm text-slate-700 dark:text-slate-300">
                ...
                <span className="font-semibold">{totalSoldCount}+</span>
                <span className="text-slate-500 dark:text-slate-400">giao dịch thành công</span>
              </div>
              <a
                href={zaloBoxUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-between gap-2 rounded-lg bg-white px-3 py-2 transition-colors hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-700"
              >
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-xs font-medium text-slate-700 dark:text-slate-300">Group Tư Vấn Zalo</span>
                </div>
                <ExternalLink className="h-3.5 w-3.5 text-slate-400" />
              </a>
            </div>
