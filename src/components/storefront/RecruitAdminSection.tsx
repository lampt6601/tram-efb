...
import { UserPlus, Zap, TrendingUp, ShieldCheck, Users } from "lucide-react";
    ...
    <section className="border-t border-indigo-100 bg-gradient-to-br from-indigo-50 via-slate-50 to-purple-50">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        ...
        <div className="mb-10 flex flex-col items-center text-center">
          <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-indigo-100 ring-1 ring-indigo-200">
